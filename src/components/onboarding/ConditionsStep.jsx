    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)] p-6">
      <div className="flex-1 flex flex-col max-w-md mx-auto w-full pt-4">
        ...
        >
          ...
          <span className={`font-medium ${hasNone ? 'text-[var(--primary)]' : ''}`}>
            Nessuna limitazione
          </span>
          {hasNone && (
            <svg className="w-5 h-5 ml-auto text-[var(--primary)]" fill="currentColor" viewBox="0 0 20 20">
        ...
        {/* Info note */}
        <div className="bg-[var(--primary)]/10 border border-[var(--primary)]/20 rounded-xl p-4 mb-8">
